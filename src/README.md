...
* Real-time resource usage graphs (CPU & Memory)
* Live container logs with auto-scroll and syntax highlighting
* Easy container management (Start/Stop/Restart/Remove)
